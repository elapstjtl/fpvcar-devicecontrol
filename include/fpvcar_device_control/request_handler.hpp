...
namespace fpvcar::device_control {
    ...
    public:
        ...
        */
         ...
         * @note 支持的 action 包括: moveForward, moveBackward, turnLeft, turnRight, moveForwardAndTurnLeft, moveForwardAndTurnRight, moveBackwardAndTurnLeft, moveBackwardAndTurnRight, stopAll
